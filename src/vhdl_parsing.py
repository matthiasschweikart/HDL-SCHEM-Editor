        ...
        for word in word_list:
            ...
            if word[0].startswith("/*") or in_block_comment:
                ...
                if word[0] == ";":
                    ...
                    actual_library = word[
                        0
                    ]  # A library definition is missing in the VHDL, because word[0] is not stored in self.parse_result["entity_library_name"]
                    first_word_of_use_clause = False
                elif word[0] not in [" ", "\n", "\r", "\t", "."]:
                ...
                if word[0] in ["if"]:  # This hit is from "end if".
                    ...
                    word[0] == ";"
                ):  # This semicolon has followed "end process/function/procedure, sometimes with a name inbetween "end [<name>];"
                    self.region = self.return_region
